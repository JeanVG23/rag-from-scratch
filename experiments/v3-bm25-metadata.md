# Recherche BM25 IA04 avec métadonnées

Évaluation générée le 2026-09-25 09:55 UTC.
...
- Champs indexés : texte du chunk, nom du fichier source sans extension et titre de section.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| BM25 (`k1=1.5`, `b=0.75`) | 0.800 | 0.933 | 1.000 | 0.929 | 0.0110 | 0.522 |

## Erreurs observées

- Aucune référence retrouvée : 0 question(s).
- Première référence après le top 5 : 0 question(s).
...
- Les métadonnées sont concaténées au texte et utilisent le même poids BM25 ; une version ultérieure pourra scorer les champs séparément.
...
Les classements détaillés par question et les identifiants des chunks sont conservés localement dans `data/evaluations/bm25_with_metadata.json`.
